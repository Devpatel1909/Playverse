    ...
    const fetchHockeyScores = async () => {
      try {
        const [live, recent, upcoming] = await Promise.all([
          hockeyAPIService.getLiveMatches(),
          hockeyAPIService.getRecentMatches(),
          hockeyAPIService.getUpcomingMatches(),
        ]);
    ...
    <Card className="mb-4 border-l-4 border-l-red-500">
      <CardHeader className="pb-2">
        ...
        <div className="flex justify-between items-center mt-2">
          <span className="text-sm font-medium text-red-600">{match.period}</span>
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-2">
                <div className="w-8 h-8 flex items-center justify-center rounded bg-red-500 text-white">
      ...
      <CardContent>
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-2">
                <div className="w-8 h-8 flex items-center justify-center rounded bg-green-100">
                  <span className="font-bold text-sm">{match.score1}</span>
                </div>
            </div>
          </div>
          ...
          <div className="bg-red-50 p-2 rounded text-center">
            <span className="text-red-700 font-semibold">{match.result}</span>
          </div>
        </div>
      </CardContent>
    </Card>
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-red-600 text-white py-6">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-red-100 mt-2">Live matches, results, and upcoming tournaments</p>
        </div>
      </div>
...
export default HockeyLiveScoringUI;
