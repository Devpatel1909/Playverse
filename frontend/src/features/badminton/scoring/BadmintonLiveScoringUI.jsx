    ...
    const fetchBadmintonScores = async () => {
      try {
        const [live, recent, upcoming] = await Promise.all([
          badmintonAPIService.getLiveMatches(),
          badmintonAPIService.getRecentMatches(),
          badmintonAPIService.getUpcomingMatches(),
        ]);
          ...
          <div className="bg-gray-50 p-3 rounded-lg">
            <div className="grid grid-cols-2 gap-4 text-sm mb-3">
              <div className="text-center">
                <div className="font-semibold">{match.smashes1}</div>
                <div className="text-gray-600">Smashes</div>
                <div className="font-semibold">{match.smashes2}</div>
              </div>
              <div className="text-center">
                <div className="font-semibold">{match.netErrors1}</div>
                <div className="text-gray-600">Net Errors</div>
                <div className="font-semibold">{match.netErrors2}</div>
              </div>
            </div>
          </div>
        </div>
...
export default BadmintonLiveScoringUI;
