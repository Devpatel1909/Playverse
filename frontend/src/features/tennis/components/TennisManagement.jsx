...
const TennisManagement = () => {
  ...
  const [teams, setTeams] = useState([
    {
      ...
      coach: 'Ivan Ljubičić',
      homeGround: 'Wimbledon',
      contactEmail: 'info@grandslammers.com',
      contactPhone: '+44-20-1234-5678',
      established: '2022',
      players: [
        { id: 1, name: 'Roger Federer', role: 'Singles', age: 41, jerseyNumber: 1 },
        { id: 2, name: 'Serena Williams', role: 'Singles', age: 40, jerseyNumber: 23 },
        { id: 3, name: 'Novak Djokovic', role: 'Singles', age: 35, jerseyNumber: 1 }
      ]
    },
    {
      id: 2,
      _id: '2',
      name: 'Clay Court Kings',
      shortName: 'CCK',
      captain: 'Rafael Nadal',
      coach: 'Carlos Moyá',
      homeGround: 'Roland Garros',
      contactEmail: 'info@claycourtkings.com',
      contactPhone: '+33-1-9876-5432',
      established: '2021',
      players: [
        { id: 4, name: 'Rafael Nadal', role: 'Singles', age: 36, jerseyNumber: 1 },
        { id: 5, name: 'Iga Świątek', role: 'Singles', age: 21, jerseyNumber: 1 },
        { id: 6, name: 'Carlos Alcaraz', role: 'Singles', age: 19, jerseyNumber: 1 }
      ]
    },
  ]);
  ...
  const loadTeamsFromAPI = async () => {
    try {
      setError(null);
      const res = await tennisAPIService.getAllTeams();
  ...
  const saveTeamsToStorage = async (newTeams) => {
    try {
      localStorage.setItem('tennisTeams', JSON.stringify(newTeams));
      window.dispatchEvent(new CustomEvent('tennisTeamsUpdated'));
    } catch (error) {
  ...
  const saveSubAdminsToStorage = (newSubAdmins) => {
    try {
      localStorage.setItem('tennisSubAdmins', JSON.stringify(newSubAdmins));
    } catch (error) {
  ...
  const updatePlayerStats = (playerId) => {
    const newAces = Math.floor(Math.random() * 10) + 1;
    const newWinners = Math.floor(Math.random() * 20) + 5;
    const newDoubleFaults = Math.floor(Math.random() * 5);
      ...
      players: team.players.map(player => 
        player.id === playerId 
          ? {
              ...
              winners: (player.winners || 0) + newWinners,
              doubleFaults: (player.doubleFaults || 0) + newDoubleFaults,
            }
          : player
      )
    }));
  ...
  const handleAddTeam = async () => {
    ...
    try {
      ...
      tennisAPIService.validateTeamData(newTeam);
      const response = await tennisAPIService.createTeam(newTeam);
  ...
  const handleAddPlayer = async () => {
    ...
    try {
      ...
      tennisAPIService.validatePlayerData(playerData);
      const response = await tennisAPIService.addPlayer(selectedTeam._id || selectedTeam.id, playerData);
          ...
          <div className="grid grid-cols-3 gap-2 mb-3">
            ...
            <div className="p-2 text-center border rounded-lg bg-gradient-to-r from-green-500/10 to-emerald-600/10 border-green-500/20">
              <div className="flex items-center justify-center mb-0.5">
                ...
                <div className="text-sm font-bold text-green-400">{player.aces || 0}</div>
              </div>
              <div className="text-xs font-medium text-white/60">Aces</div>
            </div>
            <div className="p-2 text-center border rounded-lg bg-gradient-to-r from-yellow-500/10 to-amber-600/10 border-yellow-500/20">
              <div className="flex items-center justify-center mb-0.5">
                ...
                <div className="text-sm font-bold text-yellow-400">{player.winners || 0}</div>
              </div>
              <div className="text-xs font-medium text-white/60">Winners</div>
            </div>
          </div>
            ...
            {filteredTeams.length === 0 ? (
              <div className="py-16 text-center">
                ...
                <p className="text-sm text-white/40">
                  {searchTerm ? 'Try adjusting your search terms' : 'Create your first tennis team to get started'}
                </p>
              </div>
            ) : (
          ...
          <div>
            {filteredSubAdmins.length === 0 ? (
              <div className="py-16 text-center">
                ...
                <p className="text-sm text-white/40">
                  {searchTerm ? 'Try adjusting your search terms' : 'Add your first tennis sub-administrator to get started'}
                </p>
              </div>
            ) : (
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              ...
              <div className="relative bg-gradient-to-br from-slate-900/98 via-slate-800/98 to-slate-900/98 backdrop-blur-2xl border border-white/20 rounded-xl p-5 max-h-[90vh] overflow-y-auto">
                <div className="flex items-center justify-between mb-5">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white">Create New Tennis Team</h2>
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          ...
                          <input
                            ...
                            placeholder="Enter full name (e.g., Roger Federer)"
                            required
                          />
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          ...
                          <input
                            ...
                            placeholder="admin@tennis.sports.com"
                            required
                          />
                        </div>
                        ...
                        <div className="flex items-center justify-between p-3 transition-colors border rounded-lg bg-slate-700/30 border-white/10 hover:bg-slate-600/30">
                          <div className="flex items-center space-x-2.5">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-slate-400">Create, edit, and manage tennis teams</p>
                            </div>
                          </div>
                        ...
                        <div className="flex items-center justify-between p-3 transition-colors border rounded-lg bg-slate-700/30 border-white/10 hover:bg-slate-600/30">
                          <div className="flex items-center space-x-2.5">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-slate-400">Schedule and manage tennis matches</p>
                            </div>
                          </div>
                          <label className="relative inline-flex items-center cursor-pointer">
                            <input
                    ...
                    >
                      {loading ? (
                        <div className="flex items-center justify-center space-x-2.5">
                          ...
                          <span>Creating Tennis Sub-Administrator...</span>
                        </div>
                      ) : (
                        <div className="flex items-center justify-center space-x-2.5">
                          <UserCheck className="w-5 h-5" />
                          <span>Create Tennis Sub-Administrator</span>
                        </div>
                      )}
                    </button>
